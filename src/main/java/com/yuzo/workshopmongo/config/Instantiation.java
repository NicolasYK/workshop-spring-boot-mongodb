...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("04/05/2024"), "Partiu viagem", "Vou viajar para São Paulo. Abraço", maria);
		Post post2 = new Post(null, sdf.parse("06/03/2024"), "Bom dia!", "Acordei feliz hoje!", maria);
